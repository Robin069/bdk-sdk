...
class PurviewUnifiedCatalogClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype critical_data_elements:
     purviewunifiedcatalog.aio.operations.CriticalDataElementsOperations
    :ivar data_assets: DataAssetsOperations operations
    :vartype data_assets: purviewunifiedcatalog.aio.operations.DataAssetsOperations
    :ivar data_products: DataProductsOperations operations
    :vartype data_products: purviewunifiedcatalog.aio.operations.DataProductsOperations
    :ivar business_domain: BusinessDomainOperations operations
    :vartype business_domain: purviewunifiedcatalog.aio.operations.BusinessDomainOperations
    :ivar terms: TermsOperations operations
    :vartype terms: purviewunifiedcatalog.aio.operations.TermsOperations
    :ivar okr: OkrOperations operations
    :vartype okr: purviewunifiedcatalog.aio.operations.OkrOperations
    :ivar policies: PoliciesOperations operations
    :vartype policies: purviewunifiedcatalog.aio.operations.PoliciesOperations
    :ivar data_columns: DataColumnsOperations operations
    :vartype data_columns: purviewunifiedcatalog.aio.operations.DataColumnsOperations
